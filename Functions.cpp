...
void Simplex_Table::Transform_Into_Twin()
{
	...
	{
		cout << i << endl;
		buffer_vector.push_back(make_pair(_function[i+1]*(-1), make_pair(_number_of_equations + 1 + i, 0))); // _function begins with the free element
//		cout << i << endl;
